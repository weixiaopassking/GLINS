...
class OdomPub
{
  public:
    ...
    void Pub(const data_ns::Mat4f &odom_matrix, double time_stamp);
    void Pub(const data_ns::Mat4f &odom_matrix);

    bool HasSubscribers();

  private:
    void PubData(const data_ns::Mat4f &odom_matrix, ros::Time time_stamp);
