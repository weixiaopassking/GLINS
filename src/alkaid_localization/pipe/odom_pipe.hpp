...
#include "../module/filter/filter_interface.hpp"
#include "../module/filter/voxel.hpp"
#include "../module/registration/ndt.hpp"
#include "../module/registration/registration_interface.hpp"
...
class OdomPipe
{
  ...
  private:
    ...
    std::shared_ptr<module_ns::RegistrationInterface>  _registration_ptr;
    std::shared_ptr<module_ns::FilterInterface> _filter_ptr ;
