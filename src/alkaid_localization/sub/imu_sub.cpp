...
void IMUSub::MsgCallback(const sensor_msgs::ImuConstPtr &imu_msg_ptr)
{
    ...
    imu_data._accel << imu_msg_ptr->linear_acceleration.x, imu_msg_ptr->linear_acceleration.y,
        imu_msg_ptr->linear_acceleration.z;

    imu_data._gyro << imu_msg_ptr->angular_velocity.x, imu_msg_ptr->angular_velocity.y,
